...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    var m = mx || crumb.textContent.match(/Analyst session (\d+) of 8/);
    if (m) {
      var current = parseInt(m[1], 10);
      var pages = mx
        ? ["a1-the-gmv-equation.html", "a2-the-metric-dictionary.html",
           "a3-reading-the-funnel.html", "a4-weekly-business-review.html",
           "a5-benchmarks-and-seasonality.html", "a6-metric-governance.html"]
        : ["b1-meet-mango-lane.html", "b2-core-four-by-hand.html", "b3-build-the-gmv-tree.html",
           "b4-funnel-metrics.html", "b5-diagnose-the-drop.html",
           "b6-segment-cuts.html", "b7-the-review-pack.html", "b8-metric-spec-sheet.html"];
